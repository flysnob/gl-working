class ResponseProcessor
  class << self
    ...
    def evaluate_decision_node
      ...
      elsif @last_node.response_fatal
        value = 1
        value = 2 if @last_node.response_2 == @last_node.response_fatal
        make_response_hash(@last_node.response_fatal, @last_node.target_fatal, value)
      else
